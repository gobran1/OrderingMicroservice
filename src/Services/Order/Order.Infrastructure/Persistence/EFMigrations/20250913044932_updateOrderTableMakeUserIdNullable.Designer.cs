...
namespace Order.Infrastructure.Persistence.EFMigrations
{
    ...
    [Migration("20250913044932_updateOrderTableMakeUserIdNullable")]
    partial class updateOrderTableMakeUserIdNullable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Order.Domain.Domains.Order.Entities.Order", b =>
                {
                    ...
                    b.OwnsOne("Order.Domain.Domains.Order.ValueObjects.User", "User", b1 =>
                        {
                            b1.Property<Guid>("OrderId")
                                .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Order.Domain.Domains.Order.Entities.OrderItem", b =>
                {
                    ...
                    b.OwnsOne("Order.Domain.Domains.Order.ValueObjects.Product", "Product", b1 =>
                        {
                            b1.Property<Guid>("OrderItemId")
                                .HasColumnType("uniqueidentifier");
